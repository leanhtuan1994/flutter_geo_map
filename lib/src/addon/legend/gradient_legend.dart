...
import '../../theme/map_gradient_theme.dart';
...
typedef ValuePositionUpdater = void Function(_ValuePosition? position);
...
extension __GradientLegendLayoutParentDataGetter on RenderObject {
  _GradientLegendLayoutParentData gradientLegendLayoutParentData() {
    return parentData as _GradientLegendLayoutParentData;
  }
}
